...
public class AddAttendence
{
	...
	l1=new JLabel("ADD ATTENDENCE");
	l2=new JLabel("ENTER STUDENT ID");
	l3=new JLabel("ENTER ATTENDENCE");
	t1=new JTextField();
	t2=new JTextField();
	...
	b1.addActionListener(new ActionListener()
		{  
				...
				{ 
							...
							String attendance=t2.getText();
							String studid =t1.getText();
						CRUDOperations c=new CRUDOperations();
						c.addatt(name,fathersname,mothersname,phone,residence,DOB,email,studid,tenth,twelth,first,second,third,fourth,attendance);  
				}
		}
	);
