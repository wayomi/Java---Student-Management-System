...
public class Updatename
{
	...
	Updatename()
	{
	fr=new JFrame("UPDATE STUDENT NAME");
	l1=new JLabel("UPDATE STUDENT NAME");
	...
	b1.addActionListener(new ActionListener()
		{  
				...
				{ 
						...
						c.updatename(name,fathersname,mothersname,phone,residence,DOB,email,studid,tenth,twelth,first,second,third,fourth,attendance);  
				}
		}
	);
