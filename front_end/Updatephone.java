...
public class Updatephone
{
	...
	Updatephone()
	{
	fr=new JFrame("UPDATE STUDENT PHONE_NO");
	l1=new JLabel("UPDATE STUDENT PHONE_NO");
	l2=new JLabel("ENTER STUDENT ID");
	l3=new JLabel("ENTER STUDENT PHONE_NO");
	t1=new JTextField();
	t3=new JTextField();
	t2=new JTextField();
	...
	b1.addActionListener(new ActionListener()
		{  
				...
				{ 
						...
						c.updatephone(name,fathersname,mothersname,phone,residence,DOB,email,studid,tenth,twelth,first,second,third,fourth,attendance);  
				}
		}
	);
