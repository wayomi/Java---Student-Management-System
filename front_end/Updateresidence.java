...
public class Updateresidence
{
	...
	Updateresidence()
	{
	fr=new JFrame("UPDATE STUDENT RESIDENCE");
	l1=new JLabel("UPDATE STUDENT RESIDENCE");
	l2=new JLabel("ENTER STUDENT ID");
	l3=new JLabel("ENTER STUDENT RESIDENCE");
	t1=new JTextField();
	t2=new JTextField();
	t3=new JTextField();
	...
	b1.addActionListener(new ActionListener()
		{  
				...
				{ 
						...
						c.updateresidence(name,fathersname,mothersname,phone,residence,DOB,email,studid,tenth,twelth,first,second,third,fourth,attendance);  
				}
		}
	);
