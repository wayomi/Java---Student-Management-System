...
public class Updateemail
{
	...
	Updateemail()
	{
	fr=new JFrame("UPDATE STUDENT E-MAIL");
	l1=new JLabel("UPDATE STUDENT E-MAIL");
	l2=new JLabel("ENTER STUDENT ID");
	l3=new JLabel("ENTER STUDENT E-MAIL");
	t1=new JTextField();
	t2=new JTextField();
	t3=new JTextField();
	...
	b1.addActionListener(new ActionListener()
		{  		
				...
				{ 			
						...
						c.updateemail(name,fathersname,mothersname,phone,residence,DOB,email,studid,tenth,twelth,first,second,third,fourth,attendance);  
				}
		}
	);
